...
def load_data_alex():
    ...
    for i in range(len(test_index)):
        ...
        name = find_label_train(path_test_cat)
        ...
        name = find_label_train(path_test_dog)
